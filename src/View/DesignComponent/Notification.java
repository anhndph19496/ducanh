...
public class Notification extends javax.swing.JComponent {
    ...
    public void paint(Graphics grphcs) {
        ...
        int x = shadowSize;
        int y = shadowSize;
        int width = getWidth()-2 - shadowSize * 2;
        int height = getHeight()-2 - shadowSize * 2;
    ...
    private void initComponents() {
        ...
        lbMessage.setFont(new java.awt.Font("Segoe UI Semibold", 1, 24)); // NOI18N
        lbMessage.setForeground(new java.awt.Color(38, 38, 38));
        lbMessage.setText("Message");

        lbMessageText.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbMessageText.setForeground(new java.awt.Color(127, 127, 127));
        lbMessageText.setText("Message Text");

        lbIcon.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbIcon.setIcon(new javax.swing.ImageIcon("C:\\Users\\quanc\\OneDrive\\Documents\\NetBeansProjects\\Team1-IT17307-PRO1041\\image\\sucess.png")); // NOI18N
