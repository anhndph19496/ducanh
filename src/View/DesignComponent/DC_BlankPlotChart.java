...
public class DC_BlankPlotChart extends JComponent {

    public DC_BlankPlotChatRender getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(DC_BlankPlotChatRender blankPlotChatRender) {
    ...
    private DC_NiceScale niceScale;
    private double maxValues;
    private double minValues;
    private int labelCount;
    private String valuesFormat = "#,##0.##";
    private DC_BlankPlotChatRender blankPlotChatRender;
    ...
    public void initValues(double minValues, double maxValues) {
        ...
        this.maxValues = maxValues;
        niceScale = new DC_NiceScale(minValues, maxValues);
        repaint();
    }
