...
public class PieChart extends JComponent {
    ...
    private float borderHover = 0.06f;
    private float padding = 0.2f;

    public PieChart() {
        models = new ArrayList<>();
        setForeground(new Color(2, 2, 2));
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < models.size(); i++) {
            ...
            g2.fill(area);
            g2.setColor(new Color(47,55,90));
            g2.draw(area);
            drawAngle -= angle;
        }
        drawAngle = 90;
    ...
    private void drawPopupLabel(Graphics2D g2, double size, double angle, double labelX, double labelY, String text, String detail) {
        ...
        FontMetrics fm1 = g2.getFontMetrics(getFont().deriveFont(Font.BOLD, fontSize));
